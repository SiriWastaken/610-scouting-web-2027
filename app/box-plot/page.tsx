...
export default function BoxPlotPage() {
  ...
  const [sortKey, setSortKey] = useState<keyof TeamAggregate["rawData"]>("fuelscored");
  ...
  return <div className="mx-auto max-w-[1320px]">
    <div className="mb-7 max-w-2xl">
      <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.2em] text-[var(--green)]">03 / DISTRIBUTION VIEW</div>
      <h1 className="text-3xl font-medium tracking-tight">Box Plot</h1>
      <p className="mt-2 text-sm leading-6 text-[var(--muted)]">
        Compare the spread of a scouting statistic across the event. Select a column heading to reorder the board.
      </p>
    </div>
